        ...
        <tr>
          <td style="background:#ffffff;padding:40px;">
            ...
            <p style="margin:0 0 24px;color:#334155;font-size:15px;line-height:1.8;">
              Whether you're looking for full-service property management or help promoting your
              property across <strong>Airbnb, VRBO, Booking.com, Expedia,</strong> and
            ...
            <table cellpadding="0" cellspacing="0" style="margin:0 auto 32px;">
              <tr>
                <td style="background:#D4AF37;border-radius:6px;">
                  <a href="https://ipm.services"
                     style="display:inline-block;padding:14px 32px;color:#06121F;font-size:15px;font-weight:700;text-decoration:none;letter-spacing:0.5px;">
                    Visit ipm.services
                  </a>
                </td>
              </tr>
