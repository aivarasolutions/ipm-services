...
const SECTION_LABELS = {
  ...
  '4th Bedroom (Downstairs)':         { en: 'Kids Room (Downstairs)',                    es: 'Cuarto de Niños (Abajo)' },
...
const INITIAL_ITEMS = [
  ...
  // ===== 4TH BEDROOM (Downstairs) =====
  it(37, '4th Bedroom (Downstairs)', 'Individual twin bunk beds','Camas individuales tipo litera',  '4',           'Kids Room',   'Cuarto de Niños', 'pending', 'high', '4 separate twin beds (not paired)', '4 camas individuales (no pareadas)'),
  it(38, '4th Bedroom (Downstairs)', 'Mattress protectors',     'Protectores de colchón',          '4',           'Kids Room',   'Cuarto de Niños', 'pending', 'high'),
  it(39, '4th Bedroom (Downstairs)', 'Sheet sets',              'Juegos de sábanas',               '8',           'Kids Room',   'Cuarto de Niños', 'pending', 'high', '2 sets per bed for turnover', '2 juegos por cama para rotación'),
  it(40, '4th Bedroom (Downstairs)', 'Comforters or duvets',    'Edredones o duvets',              '4',           'Kids Room',   'Cuarto de Niños', 'pending', 'medium'),
  it(41, '4th Bedroom (Downstairs)', 'Sleep pillows',           'Almohadas para dormir',           '8',           'Kids Room',   'Cuarto de Niños', 'pending', 'high', '2 per bed (4 beds)', '2 por cama (4 camas)'),
  it(129,'4th Bedroom (Downstairs)', 'Decorative pillows',      'Almohadas decorativas',           '4',           'Kids Room',   'Cuarto de Niños', 'pending', 'low'),
  it(43, '4th Bedroom (Downstairs)', 'Nightstand lamps',        'Lámparas de mesa de noche',       '1–2',         'Kids Room',   'Cuarto de Niños', 'pending', 'medium'),
  it(44, '4th Bedroom (Downstairs)', 'Hangers',                 'Ganchos / colgadores',            '10–12',       'Kids Room',   'Cuarto de Niños', 'pending', 'medium'),
  it(45, '4th Bedroom (Downstairs)', 'Curtains',                'Cortinas',                        'Per windows', 'Kids Room',   'Cuarto de Niños', 'pending', 'medium'),
  it(46, '4th Bedroom (Downstairs)', 'TV',                      'Televisor',                       '1',           'Kids Room',   'Cuarto de Niños', 'pending', 'medium'),
  it(47, '4th Bedroom (Downstairs)', 'TV mount',                'Soporte para TV',                 '1',           'Kids Room',   'Cuarto de Niños', 'pending', 'medium'),
  it(48, '4th Bedroom (Downstairs)', 'Fake plant',              'Planta artificial',               '1',           'Kids Room',   'Cuarto de Niños', 'pending', 'low'),
