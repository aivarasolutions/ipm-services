        ...
        >
          ...
          <aside className="bg-[#0F2440] border border-[#D4AF37]/20 rounded-xl p-6 my-8 not-prose" aria-label="Editorial information">
            <p className="text-sm text-[#C9D2DE] mb-2">
              <strong className="text-white">Reviewed by:</strong> IPM Operations &amp; Revenue Team
            </p>
            <p className="text-sm text-[#C9D2DE] mb-2">
            ...
            <p className="text-xs text-[#9CA9B8] mt-3 mb-0">
              Fee and calendar behavior can change. IPM reviews this step-by-step guide against first-party
              documentation during scheduled editorial reviews.
            </p>
          </aside>
          ...
          <section className="bg-white rounded-xl shadow-lg p-8 my-10">
            ...
            <p className="text-[#334155] mb-4">The fee is NOT based on:</p>
            <ul className="space-y-2 mb-6">
              <li className="text-[#475569]">Your host rating</li>
              <li className="text-[#475569]">Your booking volume</li>
              <li className="text-[#475569]">Your property type</li>
              <li className="text-[#475569]">Your location</li>
            </ul>

            <p className="text-[#334155] mb-4">It is triggered by one thing only:</p>
            ...
            <div className="bg-[#0A1A30] rounded-lg p-6 mt-6">
              <p className="text-lg font-medium text-[#C9D2DE] m-0">
          ...
          <section className="bg-[#0A1A30] border border-[#D4AF37]/20 rounded-xl shadow-lg p-8 my-10">
            ...
            <div className="space-y-8">
              {steps.map((step, index) => (
                <div key={index} className="bg-[#0F2440] rounded-xl shadow-md p-6 border-l-4 border-[#D4AF37]">
                  <div className="flex items-start gap-4 mb-4">
                    <div className="flex-shrink-0 w-12 h-12 bg-gradient-to-r from-[#D4AF37] to-[#F2D98D] text-[#06121F] rounded-full flex items-center justify-center text-xl font-bold">
                      {step.number}
                    </div>
                    <div className="flex-1">
                      <h3 className="text-2xl font-bold text-white mb-3">{step.title}</h3>
                      <p className="text-[#C9D2DE] mb-3">{step.description}</p>
                        ...
                        <ul className="space-y-2 mb-3">
                          {step.details.map((detail, idx) => (
                            <li key={idx} className="flex items-start gap-2">
                              ...
                              <span className="text-[#C9D2DE]">{detail}</span>
                            </li>
                          ))}
                        </ul>
                      )}
                      ...
                      {step.tools && (
                        <div className="grid grid-cols-2 md:grid-cols-3 gap-3 mb-3">
                          {step.tools.map((tool, idx) => (
                            <div key={idx} className="bg-[#D4AF37]/10 rounded-lg p-3 text-sm text-center text-[#C9D2DE] font-medium">
                              {tool}
                            </div>
                          ))}
                        </div>
                      ...
                      {step.note && (
                        <p className="text-sm italic text-[#9CA9B8] mb-3">{step.note}</p>
                      )}
          ...
          <section className="bg-white rounded-xl shadow-lg p-8 my-10">
            ...
            <p className="text-[#334155] mb-6">After disconnecting API:</p>
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-green-50 rounded-lg p-4 flex items-start gap-3">
                <CheckCircle className="w-6 h-6 text-green-600 flex-shrink-0 mt-1" />
                <span className="font-medium text-[#334155]">Host fee drops from 15.5% → ~3%</span>
              </div>
              <div className="bg-green-50 rounded-lg p-4 flex items-start gap-3">
                <CheckCircle className="w-6 h-6 text-green-600 flex-shrink-0 mt-1" />
                <span className="font-medium text-[#334155]">Guest service fee returns to the guest</span>
              </div>
              <div className="bg-green-50 rounded-lg p-4 flex items-start gap-3">
                <CheckCircle className="w-6 h-6 text-green-600 flex-shrink-0 mt-1" />
                <span className="font-medium text-[#334155]">Payouts increase significantly</span>
              </div>
              <div className="bg-green-50 rounded-lg p-4 flex items-start gap-3">
                <CheckCircle className="w-6 h-6 text-green-600 flex-shrink-0 mt-1" />
                <span className="font-medium text-[#334155]">Airbnb considers you a "regular" host again</span>
              </div>
            </div>
          </section>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {keepsFeatures.map((feature, index) => (
                <div key={index} className="bg-white rounded-lg p-4 text-center shadow-md">
                  ...
                  <span className="text-[#334155] font-medium text-sm">{feature}</span>
                </div>
              ))}
            </div>
          ...
          <section className="bg-white rounded-xl shadow-lg p-8 my-10">
            ...
            <div className="space-y-4">
              {fears.map((item, index) => (
                <div key={index} className="bg-[#F8F5EF] rounded-lg p-6">
          ...
          <section className="bg-white rounded-xl shadow-lg p-8 my-10">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                <CheckCircle className="w-6 h-6 text-green-600 flex-shrink-0 mt-1" />
                <p className="text-[#334155] font-medium">API triggers the 15.5% host-only fee</p>
              </div>
              <div className="flex items-start gap-3">
                <CheckCircle className="w-6 h-6 text-green-600 flex-shrink-0 mt-1" />
                <p className="text-[#334155] font-medium">Switching to iCal restores the 3% fee instantly</p>
              </div>
              <div className="flex items-start gap-3">
                <CheckCircle className="w-6 h-6 text-green-600 flex-shrink-0 mt-1" />
                <p className="text-[#334155] font-medium">Your listing is NOT penalized</p>
              </div>
              <div className="flex items-start gap-3">
                <CheckCircle className="w-6 h-6 text-green-600 flex-shrink-0 mt-1" />
                <p className="text-[#334155] font-medium">Your payouts increase dramatically</p>
              </div>
              <div className="flex items-start gap-3">
                <CheckCircle className="w-6 h-6 text-green-600 flex-shrink-0 mt-1" />
                <p className="text-[#334155] font-medium">IPM can set up the new workflow for you</p>
              </div>
            </div>
          </section>
