        ...
        >
          ...
          <aside className="bg-[#0F2440] border border-[#D4AF37]/20 rounded-xl p-6 my-8 not-prose" aria-label="Editorial information">
            ...
            <p className="text-sm text-[#C9D2DE] mb-0">
              ...
              {' · '}
              <a
                href="https://www.airbnb.com/resources/hosting-homes/a/simplifying-airbnb-service-fees-746"
                target="_blank"
                rel="noopener noreferrer"
                className="text-[#F2D98D] underline hover:text-white"
              >
                Airbnb Resource Center: Simplifying Airbnb service fees
              </a>
            </p>
            <p className="text-xs text-[#9CA9B8] mt-3 mb-0">
              Platform policies and fee models can change. IPM reviews this guide against first-party documentation
              during scheduled editorial reviews.
            </p>
          </aside>
